    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="pt-16 h-[90vh] flex flex-col">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex-1 overflow-hidden">
          ...
          {/* Tabla - MODELO SIN TRUNCAR Y OCUPANDO ESPACIO DISPONIBLE */}
          {resultadosFiltrados.length > 0 ? (
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl border border-white/50 overflow-hidden h-[calc(100%-120px)]">
              <div className="overflow-x-auto h-full">
                <table className="min-w-full divide-y divide-slate-200/50 text-xs table-auto">
                  <thead className="bg-gradient-to-r from-slate-50/80 to-blue-50/80 backdrop-blur-sm sticky top-0 z-10">
                    <tr>
                      <th className="px-3 py-2 text-left text-[10px] font-bold text-slate-700 uppercase tracking-wider w-1/6">CÓDIGO SAP</th>
                      <th className="px-3 py-2 text-left text-[10px] font-bold text-slate-700 uppercase tracking-wider w-2/6">MODELO</th>
                      <th className="px-3 py-2 text-left text-[10px] font-bold text-slate-700 uppercase tracking-wider w-1/6">ACCESORIO</th>
                      <th
                        className="px-3 py-2 text-left text-[10px] font-bold text-slate-700 uppercase tracking-wider w-1/6 cursor-pointer hover:text-blue-600 transition-colors select-none"
                      ...
                      <th className="px-3 py-2 text-left text-[10px] font-bold text-slate-700 uppercase tracking-wider w-1/6">ESTADO</th>
                      <th className="px-3 py-2 text-left text-[10px] font-bold text-slate-700 uppercase tracking-wider w-1/6">SEDE</th>
                      <th className="px-3 py-2 text-center text-[10px] font-bold text-slate-700 uppercase tracking-wider w-1/6">ESPECIFICACIONES</th>
                    </tr>
                  </thead>
